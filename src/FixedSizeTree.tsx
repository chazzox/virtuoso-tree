...
import Tree, { createTreeComputer, NodeData, NodePublicState, TreeProps, TreeState } from './Tree';
...
export class FixedSizeTree<TData extends FixedSizeNodeData = FixedSizeNodeData> extends Tree<
	TData,
	FixedSizeNodePublicState<TData>,
